 ...
 *
 * @note The EFM8UB1 and EFM8UB3 devices can be configured to ignore
 ...
 *
 * @details
 *   Disables USB transceiver and VDD Monitor. Suspends the internal regulator
 ...
 *   VDD Monitor, and internal regulator.
 ******************************************************************************/
