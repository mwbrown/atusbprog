...
Target:         EFM8UB1, EFM8UB2, EFM8UB3, C8051F320/1, C8051F326/7, C8051F34x, C8051F38x
Tool chain:     Keil
...
Version 1.0.3
    - Added support for EFM8UB3.

Version 1.0.4
    - Fixes high temperature suspend issue on EFM8UB1 and EFM8UB3.

Version 1.0.5
    - Library will not attempt to terminate a Control Packet with a ZLP when
      the amount of data transmitted is equal to the Setup Packet's wLength.
