...
extern void SPI_0_enter_DefaultMode_from_RESET(void) {
	...
	/***********************************************************************
	 - SPI0 Clock Rate = 0x13
	 ***********************************************************************/
	SPI0CKR = (0x13 << SPI0CKR_SPI0CKR__SHIFT);
	// [SPI0CKR - SPI0 Clock Rate]$
...
extern void TIMER16_4_enter_DefaultMode_from_RESET(void) {
	...
	/***********************************************************************
	 - Timer 4 High Byte = 0xC0
	 ***********************************************************************/
	TMR4H = (0xC0 << TMR4H_TMR4H__SHIFT);
	// [TMR4H - Timer 4 High Byte]$

	// $[TMR4L - Timer 4 Low Byte]
	/***********************************************************************
	 - Timer 4 Low Byte = 0x33
	 ***********************************************************************/
	TMR4L = (0x33 << TMR4L_TMR4L__SHIFT);
	// [TMR4L - Timer 4 Low Byte]$

	// $[TMR4RLH - Timer 4 Reload High Byte]
	/***********************************************************************
	 - Timer 4 Reload High Byte = 0xC0
	 ***********************************************************************/
	TMR4RLH = (0xC0 << TMR4RLH_TMR4RLH__SHIFT);
	// [TMR4RLH - Timer 4 Reload High Byte]$

	// $[TMR4RLL - Timer 4 Reload Low Byte]
	/***********************************************************************
	 - Timer 4 Reload Low Byte = 0x33
	 ***********************************************************************/
	TMR4RLL = (0x33 << TMR4RLL_TMR4RLL__SHIFT);
	// [TMR4RLL - Timer 4 Reload Low Byte]$
